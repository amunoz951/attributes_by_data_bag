...
* Create an issue in the [GitHub repo](https://github.com/amunoz951/attributes_by_data_bag/issues)
...
* Make sure your commit messages are in the proper format. If the commit
  ...
  [GitHub repo](https://github.com/amunoz951/attributes_by_data_bag/issues), start
...
* Make sure you have added the necessary tests for your changes in the included
  attributes_by_data_bag_test cookbook and the inspec profile.
